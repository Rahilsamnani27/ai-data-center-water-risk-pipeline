...
```
water-stress-data-center-tracker/
│
├── lambdas/
...
```
s3://water-stress-tracker-rahil/raw/{state}/{timestamp}.json
s3://water-stress-tracker-rahil/historical/{state}/{timestamp}.json
```
...
```bash
git clone https://github.com/<your-username>/water-stress-data-center-tracker.git
cd water-stress-data-center-tracker
...
This is a 7-day learning project, scoped deliberately small. Being upfront about what it doesn't do:
